                ...
                <div class="row">
                    <div class="col-md-7 mx-auto">
                        <div class="mb-0 border-0 p-md-5 p-lg-0 p-4">
                            ...
                            <div class="pt-0">
                                <form action="{{route('app.store.login')}}" class="my-4" method="POST">
                                    @csrf
                                ...
                                <div class="text-center text-muted mb-4">
                                    <p class="mb-0">Don't have an account ?<a class='text-primary ms-2 fw-medium' href='{{route('app.view.register')}}'>Sign up</a></p>
                                </div>
                            </div>
                        </div>
                    </div>

            ...
            <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
                ...
                <div class="text-end">
                    <ol class="breadcrumb m-0 py-0">
                        <li class="breadcrumb-item"><a href="{{route('app.purchases.all')}}">Purchases</a></li>
                            ...
                            <form action=" " method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4 mb-3">
                                                    <div class="form-group w-100">
                                                        ...
                                                        <small id="warehouse_error" class="text-danger d-none">Please
                                                            select the first warehouse.</small>
                                                    </div>
                                                </div>

                                                <div class="col-md-4 mb-3">
                                                    <div class="form-group w-100">
                                                        <label class="form-label" for="formBasic">Vendor : <span
                                                                class="text-danger">*</span></label>
                                                            ...
                                                            <div class="table-responsive">
                                                                <table class="table border">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="py-3" id="displayDiscount">TK 0.00
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="py-3 text-primary" id="total">TK
                                                                            0.00
                                                                        </td>
                                ...
                                <div class="col-xl-12">
                                    <div class="d-flex mt-5 justify-content-end">
                                        ...
                                        <a class="btn btn-secondary" href="{{ route('app.purchases.all') }}">Cancel</a>
                                    </div>
                                </div>
                            </form>
                        </div> <!-- end card-body -->
